...
contract BMRoll {
  ...
  */
  ...
  uint constant public maxNumber = 97;
  uint constant public minNumber = 4;
  ...
  */
  ...
  event LogResult(uint indexed BetID, address indexed PlayerAddress, uint PlayerNumber, uint DiceResult, uint ProfitValue, uint BetValue, uint ContractBalance, int Status);
  /* log owner transfers */
  ...
  */
  constructor() public {
    ...
    /* init min bet (10 tron) */
    ownerSetMinBet(10000000);
  }
  ...
  betIsValid(msg.value, rollUnder)
  {
    ...
    */
    if(playerDieResult[totalBets] < playerNumber[totalBets]){
      ...
      emit LogResult(totalBets, playerTempAddress[totalBets], playerNumber[totalBets], playerDieResult[totalBets], playerTempReward[totalBets], playerTempBetValue[totalBets], address(this).balance, 1);
      ...
      */
      if(!playerTempAddress[totalBets].send(playerTempReward[totalBets])){
        emit LogResult(totalBets, playerTempAddress[totalBets], playerNumber[totalBets], playerDieResult[totalBets], playerTempReward[totalBets], playerTempBetValue[totalBets], address(this).balance, 2);
    ...
    */
    if(playerDieResult[totalBets] >= playerNumber[totalBets]){
      ...
      emit LogResult(totalBets, playerTempAddress[totalBets], playerNumber[totalBets], playerDieResult[totalBets], 0, playerTempBetValue[totalBets], address(this).balance, 0);
      
      /*
      * safe adjust contractBalance
      * setMaxProfit
      */
      contractBalance = contractBalance.add(playerTempBetValue[totalBets]);
  ...
  */
  ...
  returns (bool)
  {
    ...
    */
    function ownerSafelyAddContractBalance()
    payable public
    isHuman
    onlyTreasury
    {
    ...
    function ownerTransferTron(address sendTo, uint amount) public
    onlyOwner
    isHuman
    {
